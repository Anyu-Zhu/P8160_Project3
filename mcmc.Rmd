...
for (i in 1:length(ids)) {
    ...
    ## Randomly select
    random_select = sample(1:5, 1)
    hurr_train_1 = hurr_i[fold_index != random_select, ]
    hurr_test_1 = hurr_i[fold_index == random_select, ]
...
write.csv(beta_coef_final, "res_1_3rd_edition.csv")
```
