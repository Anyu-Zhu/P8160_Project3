...
rest_test_all = mcmc(x = Xlist[560], y = Ylist[560], ini.mu, ini.bsig, ini.sig, niter = 10000)

all_coef = colMeans(t(matrix(unlist(rest_test_all$B), 5, 10000)))
...
ids = unique(hurrican$id)
  for (i in 560:562){
    ...
    beta_coef = colMeans(t(matrix(unlist(rest_test$B), 5, 5000))[4000:5000, ])
...
res
## write.csv(res, file = "res560-691.csv")
```
...
qqplot(dat$V5, dat$latitude_d, xlab = "mcmc", ylab = "lm", main = "Q-Q Plot")
```
