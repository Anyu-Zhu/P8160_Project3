...
To understand the distribution of wind speed across the North Atlantic area, the following plot shows the mean maximum wind speed within each knot defined by the longitude and latitude from the original data `hurrican703.csv`.
...
map +
  stat_summary_2d(data = dat, aes(x = Longitude, y = Latitude, z = dat$Wind.kt), 
                  fun = mean, binwidth = c(1, 1), show.legend = TRUE, alpha = .85) + 
