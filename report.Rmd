...
Then we also select some variables by lasso and built the following Poisson regression model to evaluate the characteristics related to deaths since death is recored as count. 
$$
\begin{aligned}
